...
def main():
    ...
    xgb_model = xgb.XGBRegressor(objective="reg:squaredlogerror",
                                ...
                                subsample = 0.8,
                                random_state=random_seed)
    bagging_xgb = BaggingRegressor(base_estimator=xgb_model, n_estimators=150, random_state=random_seed)
    ...
    gbm = lgb.LGBMRegressor(n_estimators=100,
                            ...
                            subsample = 0.8,
                            random_state=42)
    bagging_gbm = BaggingRegressor(base_estimator=gbm, n_estimators=150, random_state=random_seed)
